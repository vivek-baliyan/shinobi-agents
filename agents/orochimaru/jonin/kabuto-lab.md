...
**Guardrails:** Experiments live in test projects — never modify entities, DbContext, or `Migrations/` to make one pass; model-change findings get reported, fixed by tsunade.
